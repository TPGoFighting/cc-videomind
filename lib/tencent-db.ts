...
export const TENCENT_SCHEMA_STATEMENTS = [
  `CREATE TABLE IF NOT EXISTS app_users (
    ...
    subscription_usage_started_at TIMESTAMPTZ,
  ...
  `ALTER TABLE payment_submissions ADD COLUMN IF NOT EXISTS amount_cny INTEGER`,
  `ALTER TABLE payment_submissions ADD COLUMN IF NOT EXISTS access_days INTEGER`,
  `ALTER TABLE payment_submissions ADD COLUMN IF NOT EXISTS refund_requested_at TIMESTAMPTZ`,
  `ALTER TABLE payment_submissions ADD COLUMN IF NOT EXISTS refund_reason TEXT`,
  `ALTER TABLE payment_submissions ADD COLUMN IF NOT EXISTS refunded_at TIMESTAMPTZ`,
