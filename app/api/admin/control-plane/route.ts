...
import { getAppSettings, updateAppSetting } from "@/lib/supabase/admin";
  ...
  return successResponse({
    config: {
      ...
      envOverrides: {
        ...
        baseUrl: Boolean(process.env.AI_API_BASE_URL),
        model: Boolean(process.env.AI_MODEL),
        apiKey: Boolean(process.env.AI_API_KEY),
      },
    },
    providers: PROVIDERS,
