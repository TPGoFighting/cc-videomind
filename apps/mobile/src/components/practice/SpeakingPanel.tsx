...
export const SpeakingPanel = forwardRef<SpeakingPanelHandle, SpeakingPanelProps>(
  function SpeakingPanel(
    { sentence, translationZh, accent, isRecording, isSubmitted, speakingResult, speakingError, onRecordToggle, onMessage },
    ref
  ) {
        ...
        <View style={{ alignItems: "center", gap: 20 }}>
          ...
          <View style={{ alignItems: "center", gap: 10 }}>
            ...
            <Pressable
              ...
              accessibilityLabel={isRecording ? "结束口语录音" : "开始口语录音"}
              accessibilityState={{ disabled: isSubmitted, busy: isRecording }}
              onPress={() => {
                haptics.medium();
                onRecordToggle();
              }}
            ...
            {speakingError ? (
              <Text style={{ color: theme.colors.danger, fontSize: 13, fontWeight: "700", textAlign: "center", maxWidth: 280 }}>
                {speakingError}
              </Text>
            ) : null}
          </View>
