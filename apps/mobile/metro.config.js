...
config.resolver.resolveRequest = (context, moduleName, platform) => {
  // Expo's native URL polyfill consumes the CommonJS-shaped punycode export.
  // Resolving the package's ESM entry through Metro wraps it under `default`,
  // which breaks URL parsing before the router can register the app.
